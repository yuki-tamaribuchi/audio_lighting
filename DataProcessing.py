...
class DataProcessing():
    ...
    def create_brightness_data(self):
        ...
        left_percussion_rs=resample(abs(self.hpss_percussion_left/32768),resample_size)
        right_percussion_rs=resample(abs(self.hpss_percussion_right/32768),resample_size)
